...
class Tasks(tk.Frame):
    def __init__(self, main):
        ...
        self.main = main
        self.init_main()
        self.pressure_inlet = tk.Label(bg="grey", font=('times', 20), justify=tk.LEFT, anchor='nw',text='0.00 кгс/см2')
        self.pressure_outlet = tk.Label(bg="grey", font=('times', 20), justify=tk.LEFT, anchor='nw',text='0.00 кгс/см2')
