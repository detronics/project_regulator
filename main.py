...
class Tasks(tk.Frame):
    ...
    def init_main(self):
        ...
        p_value = tk.Label(font=('times', 12), justify=tk.LEFT, anchor='nw', text='P тек 0.00 MPa')
        ...
        b_pmin.place(x=150, y=190)
        b_pmax.place(x=150, y=250)
        b_new_value.place(x=150, y=220)
        b_start_rp.place(x=300, y=220)
        b_stop_rp.place(x=400,y=220)
